  ...
  return (
    <>
      ...
      <PageSection isFilled padding={{ default: 'noPadding' }}>
        {partialLogErrors && partialLogErrors.length > 0 && (
          <Alert
            variant="warning"
            isInline
            title={`${partialLogErrors.length} component(s) could not load Conforma results`}
            data-test="conforma-partial-error-alert"
          />
        )}
